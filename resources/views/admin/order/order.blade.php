...
<div class="flex-grow p-5 ml-10">
    <div class="flex justify-between text-sm">
        ...
        <div><a href="{{ route('add') }}"><button class="bg-green-700 text-white p-2 rounded-lg text-xm flex justify-center"><ion-icon class="text-xl" name="add-outline"></ion-icon> Add category</button></a></div>
    </div>
