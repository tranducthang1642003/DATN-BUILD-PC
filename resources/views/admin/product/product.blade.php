...
<div class="flex-grow p-5 ml-10">
    ...
    <div class="flex my-6">
        <div class="px-4 border-b-2 py-1">
            <a href="{{ route('product') }}" class="flex {{ request('status') == null ? 'selected' : '' }}">
                <span {{ request('status') == null ? 'class=text-yellow-500' : '' }}>Tất cả</span>
    ...
    <!-- Các hành động đã chọn -->
    <div class="flex">
        <span>0 sản phẩm đã chọn</span>
        <button class="button_selected"><ion-icon class="mr-2 mb-1 text-purple-700 " name="bag-check-outline"></ion-icon>Hết hàng</button>
        <button class="button_selected"><ion-icon class="mr-2 mb-1 text-fuchsia-600 " name="cash-outline"></ion-icon>Giảm giá</button>
        <button class="button_selected"><ion-icon class="mr-2 mb-1 text-blue-400 " name="apps-outline"></ion-icon>Chọn tất cả</button>
        <button class="button_selected"><ion-icon class="mr-2 mb-1 text-blue-700 " name="file-tray-full-outline"></ion-icon>In mã QR</button>
        <button class="button_selected"><ion-icon class="mr-2 mb-1 text-sky-500 " name="exit-outline"></ion-icon>Xuất file</button>
        <button class="button_selected"><ion-icon class="mr-2 mb-1 text-red-500 " name="trash-outline"></ion-icon>Xóa</button>
    </div>
