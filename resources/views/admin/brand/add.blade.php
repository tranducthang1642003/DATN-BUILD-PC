                ...
                <div class="p-4">
                    <div class=" gap-4 mb-10">
                        <div class="mb-4">
                            ...
                            <input type="text" name="brand_name" id="brand_name" class="border border-slate-300 rounded-md px-4 py-2 w-full focus:outline-none focus:border-blue-500" required>
                        </div>
                    </div>
