                ...
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-4 px-6 text-right">
                            ...
                            @endforeach
                            @if ($hasProduct)
                            <button class="bg-blue-500 text-white rounded-md px-4 py-2 hover:bg-blue-700 transition flex" onclick="openChangeProductModal('modelConfirm{{ $category->id }}')">
                                Thay đổi sản phẩm
                            </button>
                            @else
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                        ...
                        <form action="{{ route('add-component') }}" method="POST">
                            ...
                            <div class="border border-gray-300 rounded p-4">
                                ...
                                <button type="submit" class="bg-blue-500 text-white rounded px-4 py-2 mt-2">Thêm vào
                                    linh kiện</button>
                            </div>
                        </form>
                        @endforeach
...
<div class="container">
    ...
    <button class="bg-green-500 text-white font-bold py-2 px-4 rounded" onclick="event.preventDefault(); document.getElementById('save-configuration-form').submit();">Lưu cấu
        hình</button>
