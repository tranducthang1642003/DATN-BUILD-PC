            ...
            <div class="p-6 pt-0 text-center">
                ...
                <div class="flex">
                    <div class="w-1/4 p-4 border-r border-gray-300">
                        ...
                        <form id="filterForm" method="GET" action="{{ route('buildpc') }}" class="text-left space-y-4">
                            <div>
                                <h5 class="text-md font-medium mb-2">Thương hiệu</h5>
                                <div class="space-y-2">
                                    @foreach($brands as $brand)
                                        <label class="block">
                                            <input type="checkbox" name="brand[]" value="{{ $brand->brand_name }}" class="mr-2">{{ $brand->brand_name }}
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                            <div class="text-right">
                                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white rounded px-4 py-2 font-semibold transition duration-300">Lọc sản phẩm</button>
                            </div>
                        </form>
                    </div>
                                    ...
                                    <form action="{{ route('add-component') }}" method="POST">
                                        ...
                                        <div class="border border-gray-300 rounded p-4">
                                            ...
                                            <div class="mt-2 flex items-center space-x-4">
                                                ...
                                                <input type="number" id="quantity" name="quantity" value="1" class="w-20 border-gray-300 rounded-md py-1 px-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white rounded px-4 py-2 font-semibold transition duration-300">Thêm vào linh kiện</button>
                                            </div>
                                        </div>
                                    </form>
                                @endforeach
...
@endforeach
    ...
    <div class="container">
        ...
        <!-- Add this in the appropriate place in your blade file -->
