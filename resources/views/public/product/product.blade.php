...
<div class="product__container max-w-screen-2xl mx-auto px-4 md:px-6 text-xs sm:text-base lg:px-8 xl:px-12">
    ...
    <div class="product__banner">
        ...
        <h1 class="text-base md:text-xl lg:text-2xl xl:text-3xl text-center pt-3 text-sky-600 font-bold pb-3">MÀN HÌNH
            MÁY TÍNH</h1>
        <div class="box-top-product bg-red-700 rounded-lg">
            <p class="text-base md:text-xl lg:text-2xl xl:text-3xl font-bold text-center pt-3 text-white">TOP 10 SẢN
                PHẨM NỔI BẬT</p>
    ...
    <div class="product__box-filter border mt-3 rounded-lg ">
        <div class="info-filter-product p-2">
            ...
            <div class="list-filter-product flex flex-wrap lg:flex-row ">
                <div
                    class="item border bg-slate-100 mt-2 p-1 pr-2 pl-2 rounded-lg mr-3 hover:text-blue-500 hover:border-blue-500">
                ...
                @foreach ($products as $product)
                    <div class="product__item">
                        <div class="bg-white rounded-lg mr-2 relative">
                            ...
                            <div class="product-info p-3">
                                <a href="" class="hover:text-blue-600 truncate-responsive"
