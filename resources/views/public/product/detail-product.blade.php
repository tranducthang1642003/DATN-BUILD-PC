    ...
    <div class="detail-product__container">
        ...
        <div class="product-detail__box-content flex flex-col lg:flex-row">
            ...
            <div class="box-right grow ml-0 md:ml-10 mt-5">
                ...
                <div class="box-price-detail flex mt-3 border-2 rounded-2xl p-1 md:p-3">
                    ...
                    <div
                        class="bg-red-700 text-red-700 font-bold text-white rounded-full ml-3 pl-3 pr-3 place-self-center block lg:hidden">
                        -25%</div>
                </div>
                <div class="detail__buy-quantity flex mt-2 md:mt-5 justify-start">
                    <div class="flex items-center space-x-4 mr-5 md:mr-10">
                        <button id="decrement"
                            class="bg-slate-200 text-black px-4 py-2 rounded-full hover:bg-amber-400">-</button>
                        <span id="quantity" class="text-base md:text-lg lg:text-xl font-medium">1</span>
                        <button id="increment"
                            class="bg-slate-200 text-black px-4 py-2 rounded-full hover:bg-amber-400">+</button>
                    </div>
                    <a class="border p-3 rounded-xl pr-5 pl-5 border-amber-400 text-amber-400 hover:bg-amber-400 hover:text-white"
                        href="">
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-white p-3 md:hidden z-10 shadow-xl border w-full">
                    <div class="detail__buy-quantity flex mt-2 md:mt-5 justify-start">
                        <div class="flex items-center space-x-4 mr-3 md:mr-10">
                            <button id="decrement"
                                class="bg-slate-200 text-black px-2 py-1 rounded-full hover:bg-amber-400">-</button>
                            <span id="quantity" class="text-xs md:text-lg lg:text-xl font-medium">1</span>
                            <button id="increment"
                                class="bg-slate-200 text-black px-2 py-1 rounded-full hover:bg-amber-400">+</button>
                        </div>
                        <a class="border p-2 text-xs md:text-base rounded-xl mr-2 pr-3 pl-3 border-amber-400 text-amber-400"
                            href="">
                            THÊM VÀO GIỎ HÀNG
                        </a>
                        <div
                            class="detail-buy-now border p-2 text-xs md:text-base md:p-3 rounded-xl pr-5 pl-5 bg-red-600 text-white text-center">
                            <a href="" class="w-full">
                ...
                <div class="box-comment mx-auto rounded-xl border p-3 md:p-5">
                    ...
                    <div class="comment-detail">
                        <div class="form-comment">
                            ...
                            <button type="submit"
                                class="w-full bg-amber-400 text-white font-bold mt-3 py-2 px-4 rounded-lg hover:bg-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-400 focus:ring-opacity-50">
                                Gửi
                            </button>
                        </div>
                    </div>
        ...
        <div class="product__box-relative mt-5">
            <div class="product__box-category">
                <div class="title">
                    <h2 class="title title-box text-base md:text-lg lg:text-xl xl:text-2xl font-semibold mb-2"> SẢN
                        PHẨM TƯƠNG TỰ </h2>
                </div>
                            ...
                            <div class="bg-white rounded-lg mr-2 border">
                                ...
                                <div class="product-img">
                                    <a href=""> <img class="w-32 mx-auto md:w-48"
                                            src="https://nguyencongpc.vn/media/product/250-25387-m--n-h--nh-asus-tuf-gaming-vg279q3a.jpg"
                                            alt=""> </a>
                                </div>
                                <div class="bg-red-900 text-white rounded-full w-24 text-center ml-3 italic "> <i
                                        class="fa-solid fa-bolt" style="color: #FFD43B;"></i>Bán chạy</div>
                                <div class="product-info p-3">
                                    <a href="" class="hover:text-blue-600 truncate-2-lines"> Màn hình ASUS TUF
                                        Gaming VG279Q3A (27 inch/ Full HD/ 180Hz/ FreeSync/ 1ms GTG) </a>
                                    ...
                                    <div
                                        class="text-red-700 font-bold text-base md:text-lg xl:text-xl lg:text-2xl mt-1">
                                        6.000.000đ</div>
                                    <div class="flex items-center">
                                        <span
                                            class="text-sm md:text-base xl:text-lg lg:text-xl text-amber-400">&#9733;</span>
                                        <span
                                            class="text-sm md:text-base xl:text-lg lg:text-xl text-amber-400">&#9733;</span>
                                        <span
                                            class="text-sm md:text-base xl:text-lg lg:text-xl text-amber-400">&#9733;</span>
                                        <span
                                            class="text-sm md:text-base xl:text-lg lg:text-xl text-gray-400">&#9733;</span>
                                        <span
                                            class="text-sm md:text-base xl:text-lg lg:text-xl text-gray-400">&#9733;</span>
