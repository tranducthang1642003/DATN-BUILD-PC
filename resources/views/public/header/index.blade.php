...
<body>
    ...
    <!-- Mobile menu -->
    <section id="mobile-menu" class="hidden fixed inset-y-0 left-0 w-64 bg-white shadow-lg transform -translate-x-0 transition-transform duration-300 ease-in-out z-50">
